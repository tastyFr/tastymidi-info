...
protected:
	...
	int processLine(ostream &out, const string &input, int lineNum);
	int processAsciiWord(ostream &out, const string &input, int lineNum);
	int processStringWord(ostream &out, const string &input, int lineNum);
	int processBinaryWord(ostream &out, const string &input, int lineNum);
	int processDecimalWord(ostream &out, const string &input, int lineNum);
	int processHexWord(ostream &out, const string &input, int lineNum);
	int processVlvWord(ostream &out, const string &input, int lineNum);
	int processMidiPitchBendWord(ostream &out, const string &input,
								 int lineNum);
	int processMidiTempoWord(ostream &out, const string &input, int lineNum);
	...
	int getWord(string &word, const string &input, const string &terminators,
				int index);
