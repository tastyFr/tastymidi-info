...
public:
	...
	// event functionality:
	MidiEvent *addEvent(int aTrack, int aTick, vector<uchar> &midiData);
	...
	MidiEvent *addNoteOff(int aTrack, int aTick, int aChannel, int key,
						  int vel);
	MidiEvent *addNoteOff(int aTrack, int aTick, int aChannel, int key);
	MidiEvent *addController(int aTrack, int aTick, int aChannel, int num,
							 int value);
	MidiEvent *addPatchChange(int aTrack, int aTick, int aChannel,
							  int patchnum);
	...
	MidiEvent *addMetaEvent(int aTrack, int aTick, int aType,
							const char *metaData);
	MidiEvent *addText(int aTrack, int aTick, const string &text);
	MidiEvent *addCopyright(int aTrack, int aTick, const string &text);
	MidiEvent *addTrackName(int aTrack, int aTick, const string &name);
	MidiEvent *addInstrumentName(int aTrack, int aTick, const string &name);
	MidiEvent *addLyric(int aTrack, int aTick, const string &text);
	MidiEvent *addMarker(int aTrack, int aTick, const string &text);
	MidiEvent *addCue(int aTrack, int aTick, const string &text);
	MidiEvent *addTempo(int aTrack, int aTick, double aTempo);
	MidiEvent *addTimeSignature(int aTrack, int aTick, int top, int bottom,
								int clocksPerClick = 24,
								int num32dsPerQuarter = 8);
	MidiEvent *addCompoundTimeSignature(int aTrack, int aTick, int top,
										int bottom, int clocksPerClick = 36,
										int num32dsPerQuarter = 8);
...
private:
	...
	ulong unpackVLV(uchar a = 0, uchar b = 0, uchar c = 0, uchar d = 0,
					uchar e = 0);
